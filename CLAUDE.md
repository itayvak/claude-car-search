...
### Score (0-100)
Mileage, Year, Price, Hand, Horsepower, 20% each (as of 2026-09-21). Calculated by the `calculate-car-score` skill (`.claude/skills/calculate-car-score/`); always use its script.
